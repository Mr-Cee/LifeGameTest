    ...
    def draw(self):
        ...
        if self.rect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0] == 1 and isClicked == False:
                if PlayerCharacter.exhaustion < PlayerCharacter.max_exhaustion:
                    ...
                    # Adjusts Health
                    if PlayerCharacter.max_hp - PlayerCharacter.hp < (
                            HP_Increase * .1):
                        PlayerCharacter.hp = PlayerCharacter.max_hp
                    else:
                        PlayerCharacter.hp += (HP_Increase * .1)

                    # Decrease Food
                    if PlayerCharacter.food > (Food_Increase * .5):
                        PlayerCharacter.food -= (Food_Increase * .5)
                    else:
...
class FoodButton:
    ...
    def draw(self):
        ...
        if PlayerCharacter.cash >= 3:
            self.image = pygame.image.load(
                'Images/Icons/button_hotdog_active.png').convert_alpha()
        else:
            self.image = pygame.image.load(
                'Images/Icons/button_hotdog_inactive.png').convert_alpha()
        ...
        if self.rect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0] == 1 and isClicked == False:
                if PlayerCharacter.food < PlayerCharacter.max_food and PlayerCharacter.cash >= 3:
                    # Adjusts Food
                    if PlayerCharacter.max_food - PlayerCharacter.food < Food_Increase:
                        PlayerCharacter.food = PlayerCharacter.max_food
                    else:
                        PlayerCharacter.food += Food_Increase
                    ...
                    if PlayerCharacter.max_hp - PlayerCharacter.hp < (
                        ...
                        PlayerCharacter.hp += (HP_Increase * .25)

                    # Decrease Exhaustion
                    if PlayerCharacter.exhaustion > (Sleep_Increase * .3):
                        PlayerCharacter.exhaustion -= (Sleep_Increase * .3)
                    else:
                        PlayerCharacter.exhaustion = 0

                    PlayerCharacter.cash -= 3
                    isClicked = True
                else:
    ...
    def draw(self):
        ...
        if self.rect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0] == 1 and isClicked == False:
                ...
                # Adjusts Health
                if PlayerCharacter.max_hp - PlayerCharacter.hp < (HP_Increase * .1):
                    PlayerCharacter.hp = PlayerCharacter.max_hp
                else:
                    PlayerCharacter.hp += (HP_Increase * .1)

                # Decrease Exhaustion
                if PlayerCharacter.exhaustion > (Sleep_Increase * .5):
                    PlayerCharacter.exhaustion -= (Sleep_Increase * .5)
                else:
                    PlayerCharacter.exhaustion = 0
                isClicked = True
...
class Button_Food_Hamburger:
    ...
    def draw(self):
        ...
        if PlayerCharacter.cash >= 7:
            self.image = pygame.image.load(
                'Images/Icons/button_hamburger_active.png').convert_alpha()
        else:
            self.image = pygame.image.load(
                'Images/Icons/button_hamburger_inactive.png').convert_alpha()
        ...
        if self.rect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0] == 1 and isClicked == False:
                if PlayerCharacter.food < PlayerCharacter.max_food and PlayerCharacter.cash >= 10:

                    # Adjusts Food
                    if PlayerCharacter.max_food - PlayerCharacter.food < (
                            Food_Increase * 1.25):
                        PlayerCharacter.food = PlayerCharacter.max_food
                    else:
                        PlayerCharacter.food += (Food_Increase * 1.25)
...
beg_food_button = BegFoodButton(screen, player_food_bar.x,
                                player_food_bar.y + 60, BTN_beg_food_img, 150,
                                50)
food_hotdog_button = FoodButton(screen, player_food_bar.x,
                                player_food_bar.y + 120, food_hotdog, 150, 50)
